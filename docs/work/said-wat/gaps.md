...
| G-002 | Confirm exact model IDs at first live test (`kimi-k2.6` non-thinking default vs `kimi-k2.7-code` fallback) | Defaults the LLM call | Jasen Pan (at test) | blocked on API key |
